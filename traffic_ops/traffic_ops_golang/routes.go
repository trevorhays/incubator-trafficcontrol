...
func Routes(d ServerData) ([]Route, http.Handler, error) {
	...
	routes := []Route{
        ...
        {1.3, http.MethodPost, `phys_locations/regions/{region}?$`, api.CreateHandler(phys_location.GetRefType(), d.DB), phys_location.PhysLocationsPrivLevel, Authenticated, nil},
